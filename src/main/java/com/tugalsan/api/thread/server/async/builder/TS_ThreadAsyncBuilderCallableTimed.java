...
public class TS_ThreadAsyncBuilderCallableTimed<R> {
    ...
    private TS_ThreadAsyncBuilderCallableTimed(Optional<Duration> max, Optional<TGS_CallableType0<R>> call) {
        this.max = max;
        this.call = call;
    }
    final public Optional<Duration> max;
    final public Optional<TGS_CallableType0<R>> call;
    ...
    public static <R> TS_ThreadAsyncBuilderCallableTimed<R> of(TGS_CallableType0<R> call) {
        return new TS_ThreadAsyncBuilderCallableTimed(Optional.empty(), Optional.of(call));
    }

    public static <R> TS_ThreadAsyncBuilderCallableTimed<R> of(Duration max, TGS_CallableType0<R> call) {
