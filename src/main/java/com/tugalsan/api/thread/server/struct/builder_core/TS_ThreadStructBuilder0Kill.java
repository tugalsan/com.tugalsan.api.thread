...
public class TS_ThreadStructBuilder0Kill {
    ...
    public TS_ThreadStructBuilder0Kill(AtomicBoolean killTrigger) {
        this._killTrigger = killTrigger;
    }
    final private AtomicBoolean _killTrigger;
    ...
    public <T> TS_ThreadStructBuilder3Main<T> main(TGS_RunnableType1<AtomicBoolean> killTrigger) {
    ...
    public <T> TS_ThreadStructBuilder3Main<T> mainTimed(Duration max, TGS_RunnableType1<AtomicBoolean> killTrigger) {
        TGS_RunnableType2<AtomicBoolean, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncRun(TGS_RunnableType1<AtomicBoolean> killTrigger) {
        TGS_RunnableType2<AtomicBoolean, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncRun(Duration max, TGS_RunnableType1<AtomicBoolean> killTrigger) {
        TGS_RunnableType2<AtomicBoolean, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncAwait(TGS_RunnableType1<AtomicBoolean> killTrigger) {
        TGS_RunnableType2<AtomicBoolean, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
        var main = new TS_ThreadStructBuilder3Main(_killTrigger, "Unnamed", TS_ThreadStructCallableTimed.of(), TS_ThreadStructRunnableTimedType2.run(killTrigger_initObj));
        return TS_ThreadStruct.of(main.killTrigger, main.name, main.init, main.main, TS_ThreadStructRunnableTimedType1.empty(), Optional.empty(), Optional.empty()).asyncAwait();
    }

    public <T> TS_ThreadStruct<T> asyncAwait(Duration max, TGS_RunnableType1<AtomicBoolean> killTrigger) {
        TGS_RunnableType2<AtomicBoolean, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
        var main = new TS_ThreadStructBuilder3Main(_killTrigger, "Unnamed", TS_ThreadStructCallableTimed.of(), TS_ThreadStructRunnableTimedType2.run(killTrigger_initObj));
        return TS_ThreadStruct.of(main.killTrigger, main.name, main.init, main.main, TS_ThreadStructRunnableTimedType1.empty(), Optional.empty(), Optional.empty()).asyncAwait(max);
    }
}
