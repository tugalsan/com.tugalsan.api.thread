...
public class TS_ThreadStructBuilder0Kill {
    ...
    public TS_ThreadStructBuilder0Kill(TS_ThreadKillTrigger killTrigger) {
        this._killTrigger = killTrigger;
    }
    final private TS_ThreadKillTrigger _killTrigger;
    ...
    public <T> TS_ThreadStructBuilder3Main<T> main(TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStructBuilder3Main<T> mainTimed(Duration max, TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncRun(TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncRun(Duration max, TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
    ...
    public <T> TS_ThreadStruct<T> asyncRunAwait(TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
        var main = new TS_ThreadStructBuilder3Main(_killTrigger, "Unnamed", TS_ThreadStructCallableTimed.of(), TS_ThreadStructRunnableTimedType2.run(killTrigger_initObj));
    ...
    public <T> TS_ThreadStruct<T> asyncRunAwait(Duration max, TGS_RunnableType1<TS_ThreadKillTrigger> killTrigger) {
        TGS_RunnableType2<TS_ThreadKillTrigger, Object> killTrigger_initObj = (kt, initObj) -> killTrigger.run(kt);
        var main = new TS_ThreadStructBuilder3Main(_killTrigger, "Unnamed", TS_ThreadStructCallableTimed.of(), TS_ThreadStructRunnableTimedType2.run(killTrigger_initObj));
